...
import ModalCreateAddressEmployee from './ModalCreateAddressEmployee';
import ModalUpdateAddressEmployee from './ModalUpdateAddressEmployee';
import { useSelector, useDispatch } from 'react-redux';
import { fetchAllAddress, updateAddressTypeByIdAddress, deleteByIdAddress } from '../../../../../redux/action/addressAction';
import { toast } from 'react-toastify';

const ModalAddressEmployee = ({ idEmployee }) => {
    ...
    useEffect(() => {
        if (showAddressModal) {
            dispatch(fetchAllAddress(idEmployee));
        }
    }, [dispatch, showAddressModal, idEmployee]);
    ...
    return (
        <>
            ...
            {showCreateModal && (
                <ModalCreateAddressEmployee
                    idEmployee={idEmployee}
                    onSubmitSuccess={handleShowAddressAfterSubmit}
                />
            )}
            {showUpdateModal && (
                <ModalUpdateAddressEmployee
...
export default ModalAddressEmployee;
